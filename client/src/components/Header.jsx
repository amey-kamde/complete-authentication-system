    ...
    className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      className='w-36 h-36 rounded-full mb-6'
       ...
       >Hey {userData ? userData.name : 'Developer'}!
        ...
        src={assets.hand_wave} alt="Header Icon" />
       </h1>
       <h2
       className='text-3xl sm:text-5xl font-semibold mb-4'> Welcome to our Page</h2>

       <p
       className='mb-8 max-w-md'>Let's give a quick start and have you onboarded in no time</p>
       <button
