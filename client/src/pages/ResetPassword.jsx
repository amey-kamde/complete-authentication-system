    ...
    <div
      ...
      {!isEmailSent &&
        <form
          ...
          className='bg-slate-900 p-8 rounded-lg shadow w-96 text-sm' >
          <h1
            className='text-white text-2xl font-semibold text-center mb-4'>
            Reset Password
          </h1>
          <p
            className='text-senter mb-6 text-indigo-300'>Enter your registered email id</p>
          <div
            className='flex mb-4 items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img
              className='w-3 h-3'
      ...
      {!isOtpSubmitted && isEmailSent &&
        <form
          ...
          <p
            className='text-senter mb-6 text-indigo-300'>Enter the 6-digit code sent to your email id</p>
          <div
      ...
      {isOtpSubmitted && isEmailSent &&
        ...
        onSubmit={onSubmitNewPassword}
          ...
          <p
            className='text-senter mb-6 text-indigo-300'>Enter the new password below</p>
          <div
            className='flex mb-4 items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img
              className='w-3 h-3'
